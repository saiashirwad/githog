...
export const claimReady = Effect.fn("homestead/claim-ready")(function* (
  readyLabel: string,
  wipLabel: string,
  number: number,
) {
...
const swapLabel = Effect.fn("homestead/swap-label")(function* (fromLabel: string, toLabel: string, number: number) {
  const ref = String(number);
...
export const markReview = Effect.fn("homestead/mark-review")(function* (
  wipLabel: string,
  reviewLabel: string,
  number: number,
) {
...
export const markBlocked = Effect.fn("homestead/mark-blocked")(function* (
  wipLabel: string,
  blockedLabel: string,
  number: number,
  reason: string,
